...
int main()
{
	...
	std::cout << "\nNumero1 na main= " << Num1;
	std::cout << "\nNumero2 na main= " << Num2;
...
void TrocaNumeros(int Num1, int Num2)
{
	...
	std::cout << "\nNum1 e Num2 dentro da função TrocaNumeros são variáveis diferentes das Num1 e Num2 da função main";
	std::cout << "\nComo está função é void, não retorna nada para a main";
	std::cout << "\nNum1 Função após troca= " << Num1;
	std::cout << "\nNum2 Função após troca= " << Num2 << "\n";
