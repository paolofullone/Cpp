...
int main()
{
	...
	int Tam = sizeof(Numeros) / sizeof(int); // Divide o tamanho total pelo tamanho do dado em bytes
...
void DuplicaVetor(int* Array, int Tam)
{
	...
	//do vetor
	std::cout << "Duplica Vetor" << std::endl;
	for (int i = 0; i < Tam; i++)
	{
		Array[i] = 2 * Array[i];
	}
...
int* InverteVetor(int* Array, int Tam)
{
	std::cout << "Inverte Vetor" << std::endl;
...
void MostraVetor(int* Array, int Tam)
{
	std::cout << "Mostra Vetor" << std::endl;
