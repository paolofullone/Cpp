...
int main()
{
	...
	// um ponteiro também é uma variável, que armazenda dentro dele o endereço de memória.
	...
	// e como não definimos nenhum valor para ptr:
	std::cout << "\nValor de ptr: " << ptr << "\n";

	// printa um monte de CCCCCCCC, wtf?
