...
// Coerção - quando o próprio compilador faz uma conversão de tipos, sem declararmos entre ( ), por exemplo uma função tipada com float pode retornar um int.
// char 
...
// se recebesse inteiro e quisesse retornar float, esse é um cast. 
// Na função acima, o retorno é float, se retornar um inteiro, o próprio compilador faz a conversão pra int, é uma coerção.
