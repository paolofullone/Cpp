...
int main()
{
	...
	// Contudo trata-se de um ponteiro. Lembre... Como acessar o apontado pelo ponteiro? Isso mesmo com desreferenciamento*
	...
	// CasaDePraia->SetNumQuartos(5); é o mesmo que: (*CasaDePraia).SetNumQuartos(5);
